...
public class DatabaseUserManager {
    ...
    public boolean checkUserByUsernameAndPassword(User user) throws SQLException {
        ...
        try{
            ...
            ServerHelper.logger.log(Level.INFO, "Выполнен запрос SELECT_USER_BY_USERNAME_AND_PASSWORD");
            return resultSet.next();
        }
        catch (SQLException e){
            //e.printStackTrace();
            ServerHelper.logger.log(Level.SEVERE, "Ошибка во время выполнения запроса SELECT_USER_BY_USERNAME_AND_PASSWORD");
    ...
    public boolean insertUserToDatabase(User user) throws SQLException {
        ...
        try{
            ...
            ServerHelper.logger.log(Level.INFO, "Выполнен запрос INSERT_USER");
            return true;
        }
        catch (SQLException e){
            //e.printStackTrace();
            ServerHelper.logger.log(Level.SEVERE, "Ошибка во время выполнения запроса INSERT_USER");
    ...
    public User getUserById(Integer id) throws SQLException {
        ...
        try {
            ...
            ServerHelper.logger.log(Level.SEVERE, "Ошибка во время выполнения запроса SELECT_USER_BY_ID");
    ...
    public Integer getUserIdByUsernameAndPassword(User user) throws SQLException {
        ...
        try{
            ...
            ServerHelper.logger.log(Level.SEVERE, "Ошибка во время выполнения запроса SELECT_USER_ID_BY_USERNAME_AND_PASSWORD");
